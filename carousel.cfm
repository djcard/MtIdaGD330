...
<!--- The wrapper for the whole carousel --->
<div id="readDeseCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="item active" >
            <img src="/CodeBase/includes/classimages/AOGG.jpg" alt="..." style="margin-left:auto; margin-right:auto">
        ...
        <!--- Slide 2--->
        <div class="item">
            <img src="/CodeBase/includes/classimages/AmeliaBedelia.jpg" alt="..." style="margin-left:auto; margin-right:auto">
            <div class="carousel-caption">
        ...
        <!--- Slide 3--->
        <div class="item">
            <img src="/CodeBase/includes/classimages/EncyclopediaBrown.jpg" alt="..." style="margin-left:auto; margin-right:auto">
            <div class="carousel-caption">
